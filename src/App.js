...
function App(){
    ...
    return(
        ...
        <Heading changeTheme={changeTheme} toggleState={toggleState} pageView={pageView} filters={filters} setFilters={setFilters}/>
        <Router>
        <Switch>
            <Route path="/" exact>
                <HomePage changeTheme={changeTheme} toggleState={toggleState} pageView={pageView} changePageView={changePageView} filters={filters}/>
            </Route>
            <Route path="/listing/:listingid">
                <GenerateListing changePageView={changePageView} toggleState={toggleState}/>
            </Route>
            <Route>
